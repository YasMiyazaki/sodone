...
I18n.locale = :ru
ja_post.attributes = {title: 'Помощь в поиске работы', category: 'Карьера и бизнес', headline: 'Помощь в написании резюме и подготовки к интервью, советы по карьере...', content: 'Resume and Interview support, Career counselling…'}
ja_post.save
I18n.locale = :en
...
I18n.locale = :ru
ja_post.attributes = {title: 'Повышение квалификации', category: 'Карьера и бизнес', headline: ' Уроки Microsoft office, бизнес манеры в Японии, уроки написания бизнес писем и правил разговора по телефону... ', content: 'Microsoft office lessons, Japanese Business Manner lessons, Email and Phone lessons…'}
ja_post.save
I18n.locale = :en
...
I18n.locale = :ru
ja_post.attributes = {title: 'Советы связанные с работой', category: 'Карьера и бизнес', headline: 'Бизнес советы по бизнесу между Японикй и вашей родной страной, интервью с носителями языка о местном рынке...', content: 'Business advice for business between Japan and your country, Interview for maket needs…'}
ja_post.save
I18n.locale = :en
...
I18n.locale = :ru
ja_post.attributes = {title: 'Помощь в определённых заданиях', category: 'Карьера и бизнес', headline: 'Выполнение простых заданий, создание документов,  проведения коротких исследований, маркетинг...', content: 'Outsoucing simple tasks, document creation, investigation, maketing…)'}
ja_post.save
I18n.locale = :en
