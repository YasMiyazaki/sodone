...
ja_post =Post.find(1)
I18n.locale = :ru
ja_post.attributes = {title: 'Воспитание детей, помощь с домашними делами', category: 'Жизнь в Японии', headline: 'Услуги няни, уборка дома, забрать ребёнка из школы, переезд...', content: 'Babysitting, Support housekeeping, Pick-up from school, Moving…'}
ja_post.save
ja_post =Post.find(2)
I18n.locale = :ru
ja_post.attributes = {title: 'Изучение японского языка', category: 'Жизнь в Японии', headline: 'Советы по изучунию японского языка и обучение в Японии', content: 'Learn Japanese, Tutoring for school exams, Support study abroad…'}
ja_post.save
ja_post =Post.find(3)
I18n.locale = :ru
ja_post.attributes = {title: 'Осмотр достопримечательностей', category: 'Жизнь в Японии', headline: 'Гид, планирование путешествия, окунуться в иностранную культуру...', content: 'Guide, Support planning, Cultural tour…'}
ja_post.save
ja_post =Post.find(4)
I18n.locale = :ru
ja_post.attributes = {title: 'Административные процедуры', category: 'Жизнь в Японии', headline: 'Помощь в оформлении визы, открытия банковского счёта, контракта на телефон, настройки электронной техники...', content: 'Support Visa application, open bank account, phone contract, electricity settings…'}
ja_post.save
ja_post =Post.find(5)
I18n.locale = :ru
ja_post.attributes = {title: 'Услуги связанные с родной страной', category: 'Родная культура', headline: 'Готовка национальной еды, услуги красоты (Стрижка, покраска волос, маникюр, массаж)...', content: 'Cook meals, Beauty Service(Hair, Nail, Massage)…'}
ja_post.save
ja_post =Post.find(6)
I18n.locale = :ru
ja_post.attributes = {title: 'Изучать о своей родной стране', category: 'Родная культура', headline: 'Изучение родного языка, истории, культуры, услуги репититора...', content: 'Learn your native language, history, culture, Tutoring, Experience native culture…'}
ja_post.save
ja_post =Post.find(7)
I18n.locale = :ru
ja_post.attributes = {title: 'Помощь в поиске работы', category: 'Картера и бизнес', headline: 'Помощь в написании резюме и подготовки к интервью, советы по карьере...', content: 'Resume and Interview support, Career counselling…'}
ja_post.save
ja_post =Post.find(8)
I18n.locale = :ru
ja_post.attributes = {title: 'Повышение квалификации', category: 'Картера и бизнес', headline: ' Уроки Microsoft office, бизнес манеры в Японии, уроки написания бизнес писем и правил разговора по телефону... ', content: 'Microsoft office lessons, Japanese Business Manner lessons, Email and Phone lessons…'}
ja_post.save
ja_post =Post.find(9)
I18n.locale = :ru
ja_post.attributes = {title: 'Советы связанные с работой', category: 'Картера и бизнес', headline: 'Бизнес советы по бизнесу между Японикй и вашей родной страной, интервью с носителями языка о местном рынке...', content: 'Business advice for business between Japan and your country, Interview for maket needs…'}
ja_post.save
ja_post =Post.find(10)
I18n.locale = :ru
ja_post.attributes = {title: 'Помощь в определённых заданиях', category: 'Картера и бизнес', headline: 'Выполнение простых заданий, создание документов,  проведения коротких исследований, маркетинг...', content: 'Outsoucing simple tasks, document creation, investigation, maketing…)'}
ja_post.save
ja_post =Post.find(11)
I18n.locale = :ru
ja_post.attributes = {title: 'Перевод текстов', category: 'Язык', headline: 'От коротких предложений до перевода документов.', content: 'From business to private matters.'}
ja_post.save
ja_post =Post.find(12)
I18n.locale = :ru
ja_post.attributes = {title: 'Услуги переводчика', category: 'Язык', headline: 'Для работы и вне работы. Онлайн видео, телефон. ', content: 'From business to private matters with online video or phone.'}
ja_post.save
